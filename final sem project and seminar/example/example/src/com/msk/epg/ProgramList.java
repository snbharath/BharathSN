...
public class ProgramList extends Activity implements OnClickListener
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		try
		{
			...
			HttpPost httppost=new HttpPost("http://mobileepg.net63.net/programlistwithtime.php?prog="+name+"&date="+Date+"&time="+time);
		...
		{
			Log.e("Exception in Program List 3", e.toString());
		}
